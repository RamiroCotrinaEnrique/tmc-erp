...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2026 a las 20:53:54
...
(1, '20160364719', 'EMPRESA DE TRANSPORTES MANUEL JESUS CAMPOS CALLUPE S.R.L.', 'TMC', 'JR. MINERIA NRO. 320 URB. LOS FICUS LIMA LIMA SANTA ANITA', '99999998', 'info@transportescampos.com', '2026-03-19 22:53:53', '2026-03-24 12:21:17', NULL);
...
CREATE TABLE `hoja_liquidacion` (
  ...
  `hoja_operacion` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Usuario Administrado', 'admin', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 'Administrador', 'vistas/img/usuarios/admin/254.jpg', 1, '2026-03-24 14:33:21', '2026-03-18 15:45:24', '2026-03-24 19:33:21', NULL, 0),
...
--
ALTER TABLE `auditoria_general`
  MODIFY `aud_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `detalle_movimiento`
  MODIFY `deta_movi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `hoja_liquidacion`
  MODIFY `hoja_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `movimientos`
--
ALTER TABLE `movimientos`
  MODIFY `movi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `usuarios_modulos`
  MODIFY `umod_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
