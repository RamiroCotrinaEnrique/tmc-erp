            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card card-secondary card-outline collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-history mr-1"></i> Auditoria de Operaciones</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-plus"></i>
                                </button>
                        ...
                        <div class="card-body">
                            <table id="tablaAuditoriaOpts" class="table table-bordered table-striped tablas">
                                <thead>
                                    <tr>
                                        <th style="width:10px">#</th>
                                        <th>Fecha</th>
                                ...
                                <tbody>
                                    <?php
                                    $auditoriasOpts = ControladorOpts::ctrMostrarAuditoriaOpts(300);
                                    if ($auditoriasOpts && count($auditoriasOpts) > 0) {
                                        foreach ($auditoriasOpts as $key => $value) {
